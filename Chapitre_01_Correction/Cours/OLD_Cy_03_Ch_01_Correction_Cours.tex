...
\end{methode}
\begin{rem}
Le choix de $T_i$ peut aussi se faire par compensation de pôle. C'est à dire que lorsque la FTBO est connue sous forme factorisée ($(1+\tau_1 p)(1+\tau_2 p)$ par exemple), on prendra $T_i = \tau_1$ de façon à supprimer l'effet de ce pôle.
