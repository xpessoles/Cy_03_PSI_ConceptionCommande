...
\begin{itemize}
\item Avec la BO non corrigée, on cherche $\omega_{\SI{0}{dB}}$ tel que $\varphi(\omega_{\SI{0}{dB}})$ respecte la marge de phase souhaitée. 
\item Avec la BO non corrigée, on calcule $G_{dB}\left(\omega_{\SI{0}{dB}}\right)$. 
...
\begin{itemize}
\item Avec la BO non corrigée, on cherche $\omega_{-180\degres}$ tel que $\varphi(\omega_{-180\degres})=-180\degres$.
\item Avec la BO non corrigée, on calcule $G_{dB}\left(\omega_{-180\degres}\right)$. 
...
\item Avec la BO non corrigée, on cherche $\omega_{\SI{0}{dB}}$ tel que $\varphi(\omega_{\SI{0}{dB}})$ respecte la marge de phase souhaitée. 
\item Avec la BO non corrigée, on calcule $G_{dB}\left(\omega_{\SI{0}{dB}}\right)$. 
\item On cherche $K$ tel que $G_{dB}\left(\omega_{\SI{0}{dB}}\right)=0$
...
\begin{rem}
On peut prendre $K=\dfrac{1}{\sqrt{a}}$.
\end{rem}
...
\begin{demo}
On a d'une part : $\dfrac{1}{2}\left(\log \left(\dfrac{1}{\tau}\right)+\log \left(\dfrac{1}{a\tau}\right)\right)=\log \left(\dfrac{1}{a\tau^2}\right)^{1/2}=\log \left(\dfrac{1}{\tau\sqrt{a}}\right)$ et $\omega_{\text{max}}=\dfrac{1}{\tau\sqrt{a}}$.
